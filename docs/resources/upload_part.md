...
page_title: "openai_upload_part Resource - terraform-provider-openai"
subcategory: ""
description: |-
  Manages a part of a multipart upload.
---

# openai_upload_part (Resource)
...
- `data` (String, Sensitive) The base64 encoded data of the part.
- `part_number` (Number) The part number, starting from 1.
- `upload_id` (String) The ID of the upload session.

### Optional

- `size` (Number) The size of the part in bytes.

### Read-Only

- `etag` (String) The ETag of the uploaded part.
- `id` (String) The identifier of the upload part.
