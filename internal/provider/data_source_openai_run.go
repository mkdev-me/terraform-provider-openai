...
var _ datasource.DataSource = &RunDataSource{}

func NewRunDataSource() datasource.DataSource {
...
type RunDataSourceModel struct {
	...
	Result              *RunDataSourceResultModel `tfsdk:"result"` // For convenient output access? Or stick to flat structure?
	// The API returns RunResponse which is flat.
...
type RunDataSourceUsageModel struct {
...
type RunDataSourceResultModel struct {
	// ... could add computed result fields if needed, but existing run object is sufficient
}

func (d *RunDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_run"
}

func (d *RunDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Use this data source to retrieve information about a specific OpenAI run.",
		Attributes: map[string]schema.Attribute{
			...
			"response_format": schema.StringAttribute{
				Description: "The response format used for this run.",
				Computed:    true,
			},
		},
	}
...
func (d *RunDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
